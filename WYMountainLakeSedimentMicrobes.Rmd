...
pdf("Figures/NMDS_19Aug2023_stardeepdepauperate.pdf", width=5, height=4.5)
par(mar=c(4, 4, 2, 1), xpd=TRUE)
...
pdf("Figures/NMDS_16Aug2023_refcommunities_legend.pdf", width=5, height=4.5)
...
title(ylab="NMDS2", line = 2, cex.lab=1.2)
plot(ord.fit, labels=c("", "",""),p.max=0.05, col="black",lwd=6, cex=1.6)
legend(x=3, y=1,legend=c("A","B"), pch=c(16,8), cex=1.5, col = '#a6611a' ,title="Group")
dev.off()
...
```{r}
ord_df$shape<-rep(16,nrow(ord_df))
ord_df[ord_df$depth>26,]$zone_col<-'#a6611a80' #black


pdf("Figures/NMDS_19Aug2023_graphsum.pdf", width=5, height=4.5)
par(mar=c(4, 4, 2, 1), xpd=TRUE)
...
## 9. Test for phylogenetic signal 
...
Following code chunk provided by Dr. John Pearman from the Cawthorn Institute in Nelson, NZ
