...
#with species
tax_table <- assignTaxonomy(fasta, "silva_nr99_v138.1_wSpecies_train_set.fa.gz")
...
tax_table$ESV<-NULL
write.csv(tax_table,"Silva138_assignedTaxonomy_toSpecies_27Apr2023.csv")
...
```{r}
tax_table<-read.csv("Silva138_assignedTaxonomy_toGenus_27Apr2023.csv", header=T)
length(unique(tax_table$X))
duplicated
