...
Subset ESV table for ESVs with 10+ reads for computational tractabili

For computational tractability, we subset the phylogenetic tree (made with ESVs with 10 or more reads) by the most abundant ESVs in each depth bin (0-26 by 2)
...
```{bash}
rsync /Users/jordanscheibe/Library/CloudStorage/OneDrive-UniversityofWyoming/LakeSedDNA/Data/WYLakeSedMicrobes/WYLakeSedMicrobes/2024-01-19_WyLakeMicrobes_PhyloseqEnv_foriCAMP_ESVs10PlusReads.RData jvonegge@beartooth.arcc.uwyo.edu:/project/seddna/jvonegge/WY_lake_microbes/16S/iCAMP
```
